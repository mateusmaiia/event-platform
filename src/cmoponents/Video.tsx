        ...
        <div className="flex-1">
            <div className="bg-black flex justify-center">
                <div className="h-full w-full max-w-[1100px] max-h-[60vh] aspect-video">
                    <Player>
                        ...
                        <DefaultUi/>   //coloca os controles de video padrão da biblioteca, aumentar volume, pause
                    </Player>
                </div>
            </div>
            ...
            <div className="p-8 mx-auto max-w-[1100px]">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Mateus Maia</strong>
                ...
                <div className="gap-8 mt-20 grid grid-cols-2">
                    <a href="" className="bg-geray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
